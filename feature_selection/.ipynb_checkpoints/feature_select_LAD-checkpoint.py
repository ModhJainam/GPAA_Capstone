...
with open('/gpfs/gpfs0/project/gpaa/machine_learning/jainam_capstone/feature_selection/train_test_splits_LAD_b16_new.csv', 'r') as f:
...
df_binary_labeled = df_labeled.drop(columns=['sample_id', 'AGE', 'white', 'black', 'hispanic', 'asian', 'male', 'female'], axis=1)
...
for split in range(1,6):
    ...
    np.savetxt("/project/gpaa/machine_learning/jainam_capstone/feature_selection/feature_selection_results_new/ranked_indices_LAD_LASSO_split_"+str(split)+".csv", ranks2.argsort()[:][::-1], delimiter=",")
    split += 1
'''
...
for split in range(1,6):
    ...
    random.seed(42)
    relasso = RelaxedLassoLarsCV(cv = 5)
    ...
    np.savetxt("/project/gpaa/machine_learning/jainam_capstone/feature_selection/feature_selection_results_new/top_240_indices_LAD_ReLASSO_split_"+str(split)+".csv", ranks2.argsort()[-240:][::-1], delimiter=",")
...
for split in range(1,6):
    ...
    RF_to_write = ranks3
    np.savetxt("/project/gpaa/machine_learning/jainam_capstone/feature_selection/feature_selection_results_new/ranked_indices_LAD_random_forest_split_"+str(split)+".csv", ranks3.argsort()[:][::-1], delimiter=",")
    split += 1
'''    
############################## NSF ###########################################
...
for split in range(1,6):
    ...
    rfe_to_write = ranks1
    np.savetxt("/project/gpaa/machine_learning/jainam_capstone/feature_selection/feature_selection_results_new/ranked_indices_LAD_rfe_split_"+str(split)+".csv", ranks1.argsort()[:][::-1], delimiter=",")
    split += 1
