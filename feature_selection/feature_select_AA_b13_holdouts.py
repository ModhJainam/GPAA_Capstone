...
for split in range(1,6):
    ...
    np.savetxt("/gpfs/gpfs0/project/gpaa/machine_learning/may_2021_repo/feature_selection/holdout_feature_selections_results/top_240_indices_AA_RLASSO_b13_split_"+str(split)+".csv", ranks2.argsort()[-240:][::-1], delimiter=",")
...
for split in range(1,6):
    ...
    RF_to_write = ranks3
    np.savetxt("/gpfs/gpfs0/project/gpaa/machine_learning/may_2021_repo/feature_selection/holdout_feature_selections_results/top_240_indices_AA_random_forest_b13_split_"+str(split)+".csv", ranks3.argsort()[-240:][::-1], delimiter=",")
...
for split in range(1,6):
    ...
    rfe_to_write = ranks1
    np.savetxt("/gpfs/gpfs0/project/gpaa/machine_learning/may_2021_repo/feature_selection/holdout_feature_selections_results/top_240_indices_AA_rfe_b13_split_"+str(split)+".csv", ranks1.argsort()[-240:][::-1], delimiter=",")
