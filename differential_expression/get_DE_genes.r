...
colData_AA <- read.csv("GPAA_AA_b16_metadata_fixed.csv", row.names='sample_id')
...
write.csv(as.data.frame(noconfound_gres2_ashr), file = "noconfound_AA_DE_results.csv")
########################################################################################################

gcountData_LAD <- as.matrix(read.csv("gene_count_matrix_LAD.csv", row.names='gene_id', check.names=FALSE))
colData_LAD <- read.csv("GPAA_LAD_b16_metadata_fixed.csv", row.names = 'sample_id')
...
write.csv(as.data.frame(noconfound_gres2_ashr), file = "noconfound_LAD_DE_results.csv")
...
write.csv(as.data.frame(asr_gres2_ashr), file = "asr_AA_DE_results.csv")
...
write.csv(as.data.frame(asr_gres2_ashr), file = "asr_LAD_DE_results.csv")
